...
public class JedisDemo {
	private static final String ipAddr = "10.10.0.118";//192.168.136.72
	...
	public void testKey() throws InterruptedException {
		...
		System.out.println("新增<'username','wwm'>的键值对：" + jedis.set("username", "wwm"));
		...
		System.out.println("查看键username的剩余生存时间（秒）：" + jedis.ttl("username"));
		System.out.println("查看键username的剩余生存时间(毫秒)：" + jedis.pttl("username"));
		System.out.println("查看键username所存储的值的类型：" + jedis.type("username"));
		
		/*
		 	清空数据：OK
			判断某个键是否存在：false
			新增<'username','wwm'>的键值对：OK
			false
			...
			查看键username的剩余生存时间（秒）：3
			查看键username的剩余生存时间（毫秒）：3000
			移除键username的生存时间：1
