...
public class BarCode {
	...
	public static void encode(String contents,String dest,int width,int height,int offset) throws WriterException, FileNotFoundException, IOException{
		...
		MatrixToImageWriter.writeToStream(matrix, FORMAT, fout);
		}catch(Exception e){
			if(null!=fout){
	 ...
	 * @throws IOException
	 */
	public static void encode39(String contents,String dest,int width,int height,int offset) throws WriterException, FileNotFoundException, IOException{
		contents=new String(contents.getBytes("UTF-8"),"ISO-8859-1");
		FileOutputStream fout=null;
...
//		}
	...
	public static void main(String[] args) throws Exception {
		...
		BarCode.encode(checksum("695", "32321", "2133"), "D:\\Target.PNG", 500, 50,20);
