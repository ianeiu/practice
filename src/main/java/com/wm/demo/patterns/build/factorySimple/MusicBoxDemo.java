...
public class MusicBoxDemo {
    ...
    public static void main(String[] args) throws Exception {
       ...
       // playMusicBox(MusicBoxFactory.createMusicBox("ViolinBox"));
        ...
        playMusicBox(MusicBoxFactory.createMusicBox("com.wm.demo.patterns.build.factorySimple.PianoBox"));
        playMusicBox(MusicBoxFactory.createMusicBox("com.wm.demo.patterns.build.factorySimple.ViolinBox"));
    }
